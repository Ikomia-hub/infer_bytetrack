...
from infer_bytetrack.yolox.utils import (
    gather,
    is_main_process,
    postprocess,
    synchronize,
...
from infer_bytetrack.yolox.sort_tracker.sort import Sort
from infer_bytetrack.yolox.deepsort_tracker.deepsort import DeepSort
from infer_bytetrack.yolox.motdt_tracker.motdt_tracker import OnlineTracker
...
class MOTEvaluator:
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        if len(data_dict) > 0:
            ...
            '''
            try:
                from infer_bytetrack.yolox.layers import COCOeval_opt as COCOeval
            except ImportError:
